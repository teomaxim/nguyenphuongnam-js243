    ...
    (Yeu_cau, Dap_ung) => {
        ...
        Yeu_cau.on('end', () => {
            if (Ma_so_Xu_ly == "Doc_Danh_sach_Dien_thoai") {
                ...
                var Danh_sach_Tam=JSON.parse(JSON.stringify(Du_lieu.Danh_sach_Dien_thoai))
                
                Danh_sach_Tam.forEach(Dien_thoai=>{
                ...
                Doi_tuong_Kq.Danh_sach_Dien_thoai=Danh_sach_Tam
                Chuoi_Kq = JSON.stringify(Doi_tuong_Kq)
                */
                // C2 clone
                var Doi_tuong_Kq = {}
                Doi_tuong_Kq.Cua_hang = Du_lieu.Cua_hang
                Doi_tuong_Kq.Danh_sach_Dien_thoai = []
                // Xóa các phiếu nhập, phiếu đặt, phiếu bán (clone)
                Du_lieu.Danh_sach_Dien_thoai.forEach(Dien_thoai_Goc => {
                    var Dien_thoai = Object.assign({}, Dien_thoai_Goc)
                    Doi_tuong_Kq.Danh_sach_Dien_thoai.push(Dien_thoai)
                    delete Dien_thoai.Danh_sach_Phieu_Ban
                    delete Dien_thoai.Danh_sach_Phieu_Dat
                    delete Dien_thoai.Danh_sach_Phieu_Nhap
                })
